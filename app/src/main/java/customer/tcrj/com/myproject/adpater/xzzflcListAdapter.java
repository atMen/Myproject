 ...
 * date: 2017/9/27 .
 */
public class xzzflcListAdapter extends BaseQuickAdapter<xzzfLCInfo.DataBean, BaseViewHolder>{
    private Context mContext;

    public xzzflcListAdapter(@Nullable List<xzzfLCInfo.DataBean> data, Context context) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, xzzfLCInfo.DataBean item) {
